		...
		const sendPriceToChannel = async (message, exchange) => {
			try {
				...
				switch (exchange) {
					...
					case 'peg': announce = `<:usdvsymbolwring:914298664942465084> **$USDV** rate is at $**${await prettifyNumber(usdvPrice, 0, 5)}**`; break
...
<:usdvsymbolwring:914298664942465084> **$USDV** rate is at $**${await prettifyNumber(usdvPrice, 0, 5)}**`
				}
