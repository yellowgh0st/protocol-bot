		...
		const sendPriceToChannel = async (message, exchange) => {
			try {
				...
				switch (exchange) {
					...
					case 'mexc': announce = `<:mxc:917129131244789781> MEXC Global **$VADER** price is at *USDT* **${await prettifyNumber(mexcMarket?.vader.usdt.data?.[0]?.last, 0, 5)}**, *DAI* **${await prettifyNumber(Number(Number(mexcMarket?.vader.usdt.data?.[0]?.last) * Number(mexcMarket?.dai.usdt.data?.[0]?.last)), 0, 5)}**, *Ξ* **${await prettifyNumber((Number(mexcMarket?.vader.usdt.data?.[0]?.last) / Number(mexcMarket?.eth.usdt.data?.[0]?.last)), 0, 10)}**`; break
					case 'poloniex': announce = `<:poloniex:925869327608070186> Poloniex **$VADER** price is at *USDT* **${await prettifyNumber(poloniexMarket.vader.usdt['last'], 0, 5)}**, *DAI* **${await prettifyNumber(Number(Number(poloniexMarket.vader.usdt['last']) * Number(poloniexMarket.usdt.dai['last'])), 0, 5)}**, *Ξ* **${await prettifyNumber((Number(poloniexMarket.vader.usdt['last']) / Number(poloniexMarket.eth.usdt['last'])), 0, 10)}**`; break
...
<:mxc:917129131244789781> MEXC Global **$VADER** price is at *USDT* **${await prettifyNumber(mexcMarket?.vader.usdt.data?.[0]?.last, 0, 5)}**, *DAI* **${await prettifyNumber(Number(Number(mexcMarket?.vader.usdt.data?.[0]?.last) * Number(mexcMarket?.dai.usdt.data?.[0]?.last)), 0, 5)}**, *Ξ* **${await prettifyNumber((Number(mexcMarket?.vader.usdt.data?.[0]?.last) / Number(mexcMarket?.eth.usdt.data?.[0]?.last)), 0, 10)}**
<:poloniex:925869327608070186> Poloniex **$VADER** price is at *USDT* **${await prettifyNumber(poloniexMarket.vader.usdt['last'], 0, 5)}**, *DAI* **${await prettifyNumber((Number(poloniexMarket.vader.usdt['last']) * Number(poloniexMarket.usdt.dai['last'])), 0, 5)}**, *Ξ* **${await prettifyNumber((Number(poloniexMarket.vader.usdt['last']) / Number(poloniexMarket.eth.usdt['last'])), 0, 10)}**`
				}
